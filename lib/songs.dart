...
final  demoPlaylist = new DemoPlaylist(
  ...
  songs: [
    new DemoSong( 
       audioUrl: 'https://m.soundcloud.com/foreignfamily/jai-wolf',
       albumArtUrl: 'https://i1.sndcdn.com/avatars-000312484264-af28qp-t200x200.jpg',
       songTitle: 'INDIAN SUMMER',
       artist: 'jai-wolf',
    ),
     new DemoSong( 
       audioUrl: 'https://m.soundcloud.com/bunnyworld_saud/dhadak-title-track-dhadak-ashaan-janhvi-ajay-gogavale-shreya-ghosal-ajay-atul',
